<script lang="ts">
  import TreeNode from './TreeRspNode.svelte';
  import { createEventDispatcher } from 'svelte';
  import Tooltip from '../../asset-library/tooltip/Tooltip.svelte';
  import { getSvgIconPath } from './TreeNode/svgRouter';
  import { getBulletOrArrow } from './TreeNode/bulletRouter';
  import type { TreeNode as TreeNodeType } from '../../../stores/fileMgmt/tnodeStore';

  export let node: TreeNodeType;

  console.log('TreeReqNode: Rendering TreeNode with node:', node);
  ...
  function getHoverLabel(node: TreeNodeType) {
    return node.summary || '';
  }
